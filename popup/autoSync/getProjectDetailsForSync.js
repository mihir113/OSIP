...
function syncProjectDetails(csiNumber1) {
    startProcessing();
    console.log('syncProjectDetails');
    var projectId = document.getElementById("syncProdName").value;
    var url = "https://apex.oraclecorp.com/pls/apex/fusion_projects/implementation/getProductProjects/" + csiNumber1 + "/" + projectId;
